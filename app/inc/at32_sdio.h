...
extern sdio_info_t sd_card_info;
...
sdio_error_t sd_mult_blocks_read(uint8_t *buf, long long addr, uint16_t blk_size, uint32_t nblks);
sdio_error_t sd_block_write(const uint8_t *buf, long long addr, uint16_t blk_size);
sdio_error_t sd_mult_blocks_write(const uint8_t *buf, long long addr, uint16_t blk_size, uint32_t nblks);
